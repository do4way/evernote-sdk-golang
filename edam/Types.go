...
//  - FullMap
type LazyMap struct {
  KeysOnly map[string]struct{} `thrift:"keysOnly,1" db:"keysOnly" json:"keysOnly,omitempty"`
...
var LazyMap_KeysOnly_DEFAULT map[string]struct{}

func (p *LazyMap) GetKeysOnly() map[string]struct{} {
  return p.KeysOnly
}
...
var _elem7 string
    ...
    p.TagGuids = append(p.TagGuids, GUID(_elem7))
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
